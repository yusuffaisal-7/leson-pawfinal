            ...
            {filteredStudents.map((student) => (
              ...
              >
                <div className="p-6">
                  {/* Student Header */}
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 bg-[#70C5D7] rounded-full flex items-center justify-center text-[#ffffff] overflow-hidden">
                      {student.photoURL ? (
                        <img
          ...
          {selectedStudent && (
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2 flex justify-center mb-8">
                    <div className="w-32 h-32 bg-[#70C5D7] rounded-full flex items-center justify-center text-[#ffffff] overflow-hidden">
